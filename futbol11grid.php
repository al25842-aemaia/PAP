...
<body>
    ...
    <div class="grid-container">
        ...
        foreach ($nacionalidadeData as $nacionalidade) {
            $img_path = $nacionalidade['imagem_nacionalidade'];
            echo '<div class="cell flag"><img src="' . $img_path . '" alt="' . $nacionalidade['nacionalidade'] . '" style="width: 50px; height: auto;"></div>';
        }
        echo '</div>';
        ...
        foreach ($clubesData as $clube) {
            echo '<div class="row">';
            $img_clube_path = $clube['imagem_clube'];
            echo '<div class="cell club"><img src="' . $img_clube_path . '" alt="' . $clube['nome_clube'] . '" style="width: 50px; height: auto;"></div>';
